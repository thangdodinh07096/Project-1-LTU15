                ...
                foreach ($customers as $customer) { 
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="fas fa-shopping-basket btn btn-success" style="font-size: 20px;" href="?mod=sale&act=create_bill&id=<?php echo $customer['id']; ?>"> Tạo hóa đơn</a>
                            <!-- <a href="?mod=customer&act=delete&id=<?php echo $customer['id']; ?>" class="btn btn-danger btn-delete">Delete</a> -->
                        </td>
                    </tr>

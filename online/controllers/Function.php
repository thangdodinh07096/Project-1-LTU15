<?php 
	...
	function sendEmail($email_recive,$name,$contents,$subject){
        ...
        $mail->Username   = "thangdodinh0703@gmail.com"; // Tên đăng nhập tài khoản Gmail
        $mail->Password   = "Thang1998tlhp"; //Mật khẩu của gmail
        $mail->SetFrom("thangdodinh0703@gmail.com", "Đơn hàng"); // Thông tin người gửi
        $mail->AddReplyTo("thangdodinh0703@gmail.com","Đình Thắng");// Ấn định email sẽ nhận khi người dùng reply lại.
